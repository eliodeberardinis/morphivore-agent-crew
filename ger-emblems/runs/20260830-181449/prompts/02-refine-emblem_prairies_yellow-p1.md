# Prompt 2 — refine-emblem_prairies_yellow-p1
...
name: "Bonelord's Knuckle"
flavor: 'Still warm when you pried it off.'
id: 'emblem_prairies_yellow'  alpha_id: 'alpha_prairies_yellow'
biome: 'prairies'  opens_biome: 'wetlands'

# What review found

- [rule.no_power_field] field `grants` (deterministic check): Field `grants` claims a mechanical effect. An emblem grants no power of its own — powers come from panels (GDD §2.5). Remove the field entirely; do not set it to zero or none.
```
