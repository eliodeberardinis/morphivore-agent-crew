# Prompt 11 — refine-emblem_prairies_deadeye-p1
...
name: 'The One Good Eye'
flavor: "Thumbed out at arm's length, which is closer than it ever wanted anything to be."
id: 'emblem_prairies_deadeye'  alpha_id: 'alpha_prairies_blue'
biome: 'prairies'  opens_biome: 'wetlands'

# What review found

- [format.id_matches_alpha] field `id` (deterministic check): id is 'emblem_prairies_deadeye' but must be 'emblem_prairies_blue' — emblem_<biome>_<family>, using the Alpha's colour family (Blue), not its name.
```
