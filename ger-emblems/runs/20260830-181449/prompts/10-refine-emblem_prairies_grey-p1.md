# Prompt 10 — refine-emblem_prairies_grey-p1
...
name: "Greytyrant's Crown"
flavor: 'Took three of your limbs to get.'
id: 'emblem_prairies_grey'  alpha_id: 'alpha_prairies_grey'
biome: 'prairies'  opens_biome: 'volcanic'

# What review found

- [chain.opens_correct_biome] field `opens_biome` (deterministic check): opens_biome is 'volcanic'; an emblem opens the biome after its own, so this must be 'wetlands'.
```
