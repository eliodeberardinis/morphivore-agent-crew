# Prompt 14 — refine-emblem_prairies_green-p1
...
name: "The Green One's Tooth"
flavor: 'From an animal that does not exist.'
id: 'emblem_prairies_green'  alpha_id: 'alpha_prairies_green'
biome: 'prairies'  opens_biome: 'wetlands'

# What review found

- [world.alpha_exists] field `alpha_id` (deterministic check): alpha_id 'alpha_prairies_green' is not an Alpha in creatures.json.
```
