# Prompt 61 — refine-emblem_beach_greytyrant-p1
...
name: 'Even-Keeled Rib'
flavor: 'One rib off a cage where every rib was the same, pried out with your knee on its chest.'
id: 'emblem_beach_greytyrant'  alpha_id: 'alpha_beach_grey'
biome: 'beach'  opens_biome: 'volcanic'

# What review found

- [format.id_matches_alpha] field `id` (deterministic check): id is 'emblem_beach_greytyrant' but must be 'emblem_beach_grey' — emblem_<biome>_<family>, using the Alpha's colour family (Grey), not its name.
```
