# Prompt 54 — refine-emblem_beach_quickfang-p1
...
name: 'Sand-Scoured Heel'
flavor: 'Rubbed raw and smooth by wet sand, torn free while the rest of it was still sprinting.'
id: 'emblem_beach_quickfang'  alpha_id: 'alpha_beach_red'
biome: 'beach'  opens_biome: 'volcanic'

# What review found

- [format.id_matches_alpha] field `id` (deterministic check): id is 'emblem_beach_quickfang' but must be 'emblem_beach_red' — emblem_<biome>_<family>, using the Alpha's colour family (Red), not its name.
```
