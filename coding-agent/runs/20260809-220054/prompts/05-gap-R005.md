...
```
# Requirement: Pounce attack  (GDD 2.1)

**What the design requires**
Left-click / A launches the player at the locked creature with no charge meter; hitting a standing creature drains that creature's Health and bounces the player back.

**How you could tell it works in-game**
Pressing pounce while locked visibly leaps the beast at the target, the target's health drops, and the player recoils away from the impact.
