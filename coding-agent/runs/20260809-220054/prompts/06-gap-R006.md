...
```
# Requirement: Knockdown / dizzy state  (GDD 2.1)

**What the design requires**
At zero Health a creature does not die but collapses into a dizzy state (squashed, spinning); if left too long it rises again at half health.

**How you could tell it works in-game**
A creature reduced to zero health flattens and spins in place instead of vanishing; if the player ignores it, it stands back up with a half-full health bar.
