# Prompt 26 — refine-emblem_wetlands_nightthroat-p1
...
name: 'Leech-Beaded Gland'
flavor: 'The venom sac out of its neck, three fat leeches still hanging off it and unbothered.'
id: 'emblem_wetlands_nightthroat'  alpha_id: 'alpha_wetlands_purple'
biome: 'wetlands'  opens_biome: 'mountains'

# What review found

- [format.id_matches_alpha] field `id` (deterministic check): id is 'emblem_wetlands_nightthroat' but must be 'emblem_wetlands_purple' — emblem_<biome>_<family>, using the Alpha's colour family (Purple), not its name.
```
