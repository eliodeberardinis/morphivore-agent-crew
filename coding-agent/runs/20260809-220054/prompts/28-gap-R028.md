...
```
# Requirement: Ambient rank rules  (GDD 3.3)

**What the design requires**
Spawned creature rank is stated data: prey spawn at the player's rank minus one (floored at 1), elites at the player's rank, Alphas at the player's rank always at Clash, and the Apex at rank 6 Clash.

**How you could tell it works in-game**
A three-limb player meets two-limb prey, three-limb elites and a three-limb Clash Alpha; a one-limb player still meets rank-1 prey rather than rank-0.

**Data it implies**
creatures.json rank field; biomes.json Alpha roster

**Worked example from the document**
Player rank 1 → prey rank 1 (floored); player rank 4 → prey rank 3, elites rank 4, Alpha rank 4 Clash.
