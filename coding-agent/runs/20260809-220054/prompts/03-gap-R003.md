...
```
# Requirement: Solid bodies and obstacles  (GDD 2.1)

**What the design requires**
Creatures and terrain obstacles are solid; neither the player nor creatures may pass through them.

**How you could tell it works in-game**
Walking into a standing creature or a rock stops the player rather than overlapping it; a pounce into a standing creature bounces the player back instead of passing through.
