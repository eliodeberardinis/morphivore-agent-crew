# Prompt 71 — refine-emblem_volcanic_deadeye-p1
...
name: 'Smoke-Cooked Eye'
flavor: 'Popped, cured and shrunk hard by the vents; it never once saw you get close.'
id: 'emblem_volcanic_deadeye'  alpha_id: 'alpha_volcanic_blue'
biome: 'volcanic'  opens_biome: None

# What review found

- [format.id_matches_alpha] field `id` (deterministic check): id is 'emblem_volcanic_deadeye' but must be 'emblem_volcanic_blue' — emblem_<biome>_<family>, using the Alpha's colour family (Blue), not its name.
```
