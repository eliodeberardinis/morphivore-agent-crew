...
```
# Requirement: Dash  (GDD 2.1, 2.3)

**What the design requires**
Space / right trigger performs a dash whose speed is the form's Speed multiplied by its family Dash multiplier.

**How you could tell it works in-game**
Pressing dash produces a burst of movement; a Red Leaper's dash visibly covers far more ground than a Yellow Brawler's.

**Data it implies**
(none)

**Worked example from the document**
Red family Dash multiplier 1.6 vs Yellow 0.8 — the Red form's dash is measurably twice the Yellow form's at equal rank.
