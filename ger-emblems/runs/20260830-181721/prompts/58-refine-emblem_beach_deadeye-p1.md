# Prompt 58 — refine-emblem_beach_deadeye-p1
...
name: 'Salt-Blind Lens'
flavor: 'The good eye gone milky at the edges, because staring down a bright shore costs you something.'
id: 'emblem_beach_deadeye'  alpha_id: 'alpha_beach_blue'
biome: 'beach'  opens_biome: 'volcanic'

# What review found

- [format.id_matches_alpha] field `id` (deterministic check): id is 'emblem_beach_deadeye' but must be 'emblem_beach_blue' — emblem_<biome>_<family>, using the Alpha's colour family (Blue), not its name.
```
