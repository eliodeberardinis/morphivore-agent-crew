# Prompt 67 — refine-emblem_volcanic_quickfang-p1
...
name: 'Cinder-Burnt Tendon'
flavor: 'Pulled hot out of the back leg, still smelling like the crust it ran across barefoot.'
id: 'emblem_volcanic_quickfang'  alpha_id: 'alpha_volcanic_red'
biome: 'volcanic'  opens_biome: None

# What review found

- [format.id_matches_alpha] field `id` (deterministic check): id is 'emblem_volcanic_quickfang' but must be 'emblem_volcanic_red' — emblem_<biome>_<family>, using the Alpha's colour family (Red), not its name.
```
