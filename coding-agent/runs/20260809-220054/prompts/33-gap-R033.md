...
```
# Requirement: Emblems  (GDD 2.5, 3.3)

**What the design requires**
Knocking the Alpha down and eating it yields its emblem, which opens the way to the next biome and enables breeding while granting no power of its own; emblems persist through mutation and breeding and are recorded permanently.

**How you could tell it works in-game**
Before eating the downed Alpha the route onward is closed and breeding is unavailable; after eating it the route opens, breeding becomes available, and no stat or ability changes.

**Data it implies**
emblems.json: which Alpha drops each emblem and which biome it opens (no powers); persisted record of claimed emblems
