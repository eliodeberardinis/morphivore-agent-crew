# Prompt 10 — refine-emblem_prairies_nightthroat-p1
...
name: 'Drip Fang'
flavor: 'Snapped off at the gum and still beading, so hold it by the fat end.'
id: 'emblem_prairies_nightthroat'  alpha_id: 'alpha_prairies_purple'
biome: 'prairies'  opens_biome: 'wetlands'

# What review found

- [format.id_matches_alpha] field `id` (deterministic check): id is 'emblem_prairies_nightthroat' but must be 'emblem_prairies_purple' — emblem_<biome>_<family>, using the Alpha's colour family (Purple), not its name.
```
