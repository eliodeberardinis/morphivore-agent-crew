# Prompt 57 — refine-emblem_beach_nightthroat-p1
...
id: 'emblem_beach_nightthroat'  alpha_id: 'alpha_beach_purple'
biome: 'beach'  opens_biome: 'volcanic'

# What review found

- [format.id_matches_alpha] field `id` (deterministic check): id is 'emblem_beach_nightthroat' but must be 'emblem_beach_purple' — emblem_<biome>_<family>, using the Alpha's colour family (Purple), not its name.
```
