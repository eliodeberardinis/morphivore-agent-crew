...
```
# Requirement: The Ascension and the Apex  (GDD 2.5, The Ascension)

**What the design requires**
The Ascension is rank six's arena, not a biome: always open to any six-limb bloodline, the only place the 25 rank-6 forms exist and can be hunted. The Apex — a rank-6 Clash creature, the player's final mirror — sits dormant there and wakes only when the Bestiary holds ≥100 of 150 forms across all runs; beating it is the true ending above the Conquest. A line short of the record still Conquers, ascends and banks its top-row forms.

**How you could tell it works in-game**
A six-limb bloodline can always enter the Ascension and discover rank-6 forms there; with fewer than 100 forms recorded the Apex lies dormant and cannot be fought; at 100+ it wakes and defeating it produces the true ending.

**Data it implies**
forms.json rank-6 rows; persisted Bestiary count

**Worked example from the document**
Ranks 1–5 hold 125 forms, so ≥100 is reachable before ever entering the rank-6 row.
