...
```
# Requirement: The blank (form zero)  (GDD 2.4, 2.5)

**What the design requires**
The hatchling is a white cube with one bare limb and multiplier 1.0 on every axis; it is the empty state and is not one of the 150 forms.

**How you could tell it works in-game**
A new run starts as a plain white one-limb cube whose stats equal the rank-1 baseline exactly, and the Bestiary count does not include it.

**Data it implies**
(none)

**Worked example from the document**
Blank stats = Health 100, Damage 40, Speed 12, Reach 16.
