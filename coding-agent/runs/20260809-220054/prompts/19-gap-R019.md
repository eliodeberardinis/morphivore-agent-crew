...
```
# Requirement: Poop the oldest colour  (GDD 2.1, 2.4a)

**What the design requires**
Q / B ejects the oldest colour in the buffer, turning that limb white, so the player can clear a slot before hunting a chosen colour into it.

**How you could tell it works in-game**
Pressing poop makes the oldest-coloured limb visibly go white and no new colour is added; repeating it strips colours in eating order.
