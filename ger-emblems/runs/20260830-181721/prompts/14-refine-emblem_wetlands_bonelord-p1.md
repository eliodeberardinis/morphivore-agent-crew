# Prompt 14 — refine-emblem_wetlands_bonelord-p1
...
name: 'Bog-Packed Fist'
flavor: 'Knuckle bone with marsh mud rammed into every crack, because it went down face first.'
id: 'emblem_wetlands_bonelord'  alpha_id: 'alpha_wetlands_yellow'
biome: 'wetlands'  opens_biome: 'mountains'

# What review found

- [format.id_matches_alpha] field `id` (deterministic check): id is 'emblem_wetlands_bonelord' but must be 'emblem_wetlands_yellow' — emblem_<biome>_<family>, using the Alpha's colour family (Yellow), not its name.
```
