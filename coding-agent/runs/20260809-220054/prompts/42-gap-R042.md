...
```
# Requirement: Run restart as a one-limb blank  (GDD 1, 2.5)

**What the design requires**
When the line ends, the next run begins with a new blank white one-limb cube in a freshly generated Prairies, subject to any unlocked hatch-choice or inherited instinct.

**How you could tell it works in-game**
After death, starting again places the player as a one-limb cube in the Prairies with no traits, panels or emblems (except those granted by unlocked milestones).
