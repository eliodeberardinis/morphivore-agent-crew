# Prompt 3 — refine-emblem_prairies_bonelord-p1
...
name: 'Neckless Knuckle'
flavor: "The big fist-bone off its shoulder, still grass-stained from where it stood its ground and then didn't."
id: 'emblem_prairies_bonelord'  alpha_id: 'alpha_prairies_yellow'
biome: 'prairies'  opens_biome: 'wetlands'

# What review found

- [format.id_matches_alpha] field `id` (deterministic check): id is 'emblem_prairies_bonelord' but must be 'emblem_prairies_yellow' — emblem_<biome>_<family>, using the Alpha's colour family (Yellow), not its name.
```
