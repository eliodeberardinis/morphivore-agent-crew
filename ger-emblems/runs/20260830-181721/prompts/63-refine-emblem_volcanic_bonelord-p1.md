# Prompt 63 — refine-emblem_volcanic_bonelord-p1
...
name: 'Ash-Baked Fist'
flavor: 'Knuckle bone cooked grey through, from a thing that kept swinging in air too hot to breathe.'
id: 'emblem_volcanic_bonelord'  alpha_id: 'alpha_volcanic_yellow'
biome: 'volcanic'  opens_biome: None

# What review found

- [format.id_matches_alpha] field `id` (deterministic check): id is 'emblem_volcanic_bonelord' but must be 'emblem_volcanic_yellow' — emblem_<biome>_<family>, using the Alpha's colour family (Yellow), not its name.
```
