# Prompt 39 — refine-emblem_mountains_quickfang-p1
...
name: 'Scrabble Claw'
flavor: "Four toes' worth of hooks, all filed down to nubs by a lot of very fast bad decisions."
id: 'emblem_mountains_quickfang'  alpha_id: 'alpha_mountains_red'
biome: 'mountains'  opens_biome: 'beach'

# What review found

- [format.id_matches_alpha] field `id` (deterministic check): id is 'emblem_mountains_quickfang' but must be 'emblem_mountains_red' — emblem_<biome>_<family>, using the Alpha's colour family (Red), not its name.
```
