# Prompt 32 — refine-emblem_wetlands_greytyrant-p1
...
name: 'Slimed Shoulder Plate'
flavor: "Armour off its back, so evenly built you can't tell which half you tore first."
id: 'emblem_wetlands_greytyrant'  alpha_id: 'alpha_wetlands_grey'
biome: 'wetlands'  opens_biome: 'mountains'

# What review found

- [format.id_matches_alpha] field `id` (deterministic check): id is 'emblem_wetlands_greytyrant' but must be 'emblem_wetlands_grey' — emblem_<biome>_<family>, using the Alpha's colour family (Grey), not its name.
```
