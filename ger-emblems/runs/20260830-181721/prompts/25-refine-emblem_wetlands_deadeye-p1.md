# Prompt 25 — refine-emblem_wetlands_deadeye-p1
...
name: 'Reed-Cut Eyelid'
flavor: 'Peeled off the socket in one piece, sliced up from a lifetime of squinting through sharp grass.'
id: 'emblem_wetlands_deadeye'  alpha_id: 'alpha_wetlands_blue'
biome: 'wetlands'  opens_biome: 'mountains'

# What review found

- [format.id_matches_alpha] field `id` (deterministic check): id is 'emblem_wetlands_deadeye' but must be 'emblem_wetlands_blue' — emblem_<biome>_<family>, using the Alpha's colour family (Blue), not its name.
```
