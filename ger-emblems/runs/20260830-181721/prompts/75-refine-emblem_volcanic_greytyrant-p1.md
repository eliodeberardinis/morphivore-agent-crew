# Prompt 75 — refine-emblem_volcanic_greytyrant-p1
...
name: 'Unbroken Grey Skullcap'
flavor: 'The top of its head, thick and dull and identical all the way round, and you finally stopped looking for the soft bit.'
id: 'emblem_volcanic_greytyrant'  alpha_id: 'alpha_volcanic_grey'
biome: 'volcanic'  opens_biome: None

# What review found

- [format.id_matches_alpha] field `id` (deterministic check): id is 'emblem_volcanic_greytyrant' but must be 'emblem_volcanic_grey' — emblem_<biome>_<family>, using the Alpha's colour family (Grey), not its name.
```
