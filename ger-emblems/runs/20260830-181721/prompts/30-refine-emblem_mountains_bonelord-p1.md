# Prompt 30 — refine-emblem_mountains_bonelord-p1
...
name: 'Chipped Knuckle Stone'
flavor: 'Bone worn flat as scree from punching rock, and it never learned the rock was winning.'
id: 'emblem_mountains_bonelord'  alpha_id: 'alpha_mountains_yellow'
biome: 'mountains'  opens_biome: 'beach'

# What review found

- [format.id_matches_alpha] field `id` (deterministic check): id is 'emblem_mountains_bonelord' but must be 'emblem_mountains_yellow' — emblem_<biome>_<family>, using the Alpha's colour family (Yellow), not its name.
```
