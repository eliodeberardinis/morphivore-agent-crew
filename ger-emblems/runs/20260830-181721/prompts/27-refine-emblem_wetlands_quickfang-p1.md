# Prompt 27 — refine-emblem_wetlands_quickfang-p1
...
name: 'Split Paddle Foot'
flavor: 'Webbed and torn, from something that ran across water right up until the water ran out.'
id: 'emblem_wetlands_quickfang'  alpha_id: 'alpha_wetlands_red'
biome: 'wetlands'  opens_biome: 'mountains'

# What review found

- [format.id_matches_alpha] field `id` (deterministic check): id is 'emblem_wetlands_quickfang' but must be 'emblem_wetlands_red' — emblem_<biome>_<family>, using the Alpha's colour family (Red), not its name.
```
