# Prompt 46 — refine-emblem_beach_bonelord-p1
...
name: 'Barnacled Knucklebone'
flavor: 'Crusted white with shells, off an arm that spent years hitting surf and losing.'
id: 'emblem_beach_bonelord'  alpha_id: 'alpha_beach_yellow'
biome: 'beach'  opens_biome: 'volcanic'

# What review found

- [format.id_matches_alpha] field `id` (deterministic check): id is 'emblem_beach_bonelord' but must be 'emblem_beach_yellow' — emblem_<biome>_<family>, using the Alpha's colour family (Yellow), not its name.
```
