...
```
# Requirement: Limb baseline stat table  (GDD 2.4)

**What the design requires**
Limb count (1–6) sets baseline Health, Damage, Speed and Reach before family and intensity multipliers apply.

**How you could tell it works in-game**
Gaining a limb raises the raw bar most noticeably as durability, with speed creeping up only slightly.

**Data it implies**
Rank baseline table (limbs → Health/Damage/Speed/Reach)

**Worked example from the document**
Health 100/150/200/250/300/350; Damage 40/55/70/85/100/115; Speed 12/13/14/15/16/17; Reach 16/19/22/25/28/31 for limbs 1→6.
