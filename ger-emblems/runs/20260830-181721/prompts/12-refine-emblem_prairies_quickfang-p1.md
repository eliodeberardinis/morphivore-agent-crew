# Prompt 12 — refine-emblem_prairies_quickfang-p1
...
name: 'Twitching Hock'
flavor: 'A back leg that kept kicking dirt for a minute after the rest of it stopped caring.'
id: 'emblem_prairies_quickfang'  alpha_id: 'alpha_prairies_red'
biome: 'prairies'  opens_biome: 'wetlands'

# What review found

- [format.id_matches_alpha] field `id` (deterministic check): id is 'emblem_prairies_quickfang' but must be 'emblem_prairies_red' — emblem_<biome>_<family>, using the Alpha's colour family (Red), not its name.
```
