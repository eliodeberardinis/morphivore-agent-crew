# Prompt 72 — refine-emblem_volcanic_nightthroat-p1
...
name: 'Black Throat Sac'
flavor: 'Cut out whole and still warm, from the last mouth on this rock that bit before it looked.'
id: 'emblem_volcanic_nightthroat'  alpha_id: 'alpha_volcanic_purple'
biome: 'volcanic'  opens_biome: None

# What review found

- [format.id_matches_alpha] field `id` (deterministic check): id is 'emblem_volcanic_nightthroat' but must be 'emblem_volcanic_purple' — emblem_<biome>_<family>, using the Alpha's colour family (Purple), not its name.
```
