...
```
# Requirement: Record milestone unlocks  (GDD 2.9a)

**What the design requires**
Discovery count pays out unlocks: 5 = Hatch-choice (start as any discovered Pale form instead of the blank), 15 = Inherited instinct (begin each run holding one earned trait), 35 = Hatch-choice extends to Dusk forms, 60 = Litter floor +1 (no litter smaller than three), 100 = the Apex wakes, 135 = Ancient skin, 150 = The Whole Beast (Genesis skin, save marked 100%).

**How you could tell it works in-game**
With 5 forms recorded the run-start screen offers discovered Pale forms; with 15 the new cube already carries one trait; with 60 a bare gate clear yields three offspring instead of two; at 150 the save reads 100% and the Genesis skin is selectable.

**Data it implies**
Persisted unlock flags keyed to discovered-form thresholds

**Worked example from the document**
The first rung is 5 forms — inside what a losing first run banks before meeting an Alpha.
...
The record pays out on a ladder of deliberately **data-cheap** unlocks: | Forms | Unlock | |---|---| | **5** | **Hatch-choice** — start a run as any *discovered* Pale form, not the blank cube | | **15** | **Inherited instinct** — begin each run already holding one trait you have earned | | **35** | Hatch-choice extends to **Dusk** forms | | **60** | **Litter floor +1** — no litter is ever smaller than three again | | **100** | **The Apex wakes** — the dormant final boss answers any ascending bloodline; the game becomes winnable | | **135** | **Ancient skin** — completionist cosmetic (nearly all of ranks 1–5 plus ten rank-six forms) | | **150** | **The Whole Beast** — every form discovered; unlocks the **Genesis skin** (the newborn's white) and marks the save 100% | The first rung sits at **5 forms — inside what a losing first run banks before meeting an Alpha** — so even a first death leaves you further along; all thresholds are QA tuning targets. ---
